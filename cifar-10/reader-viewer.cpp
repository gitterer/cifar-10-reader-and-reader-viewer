...
void reader(int startval, int endval, string dataset) {
	...
	switch (datasetval) {
		case '1':
			 training_image_fn = "cifar/cifar-10/cifar-10-batches-bin/data_batch_1.bin";
		break;
		case '2':
			 training_image_fn = "cifar/cifar-10/cifar-10-batches-bin/data_batch_2.bin";
		break;
		case '3':
			 training_image_fn = "cifar/cifar-10/cifar-10-batches-bin/data_batch_3.bin";
			break;
		case '4':
			 training_image_fn = "cifar/cifar-10/cifar-10-batches-bin/data_batch_4.bin";
			break;
		case '5':
			training_image_fn = "cifar/cifar-10/cifar-10-batches-bin/data_batch_4.bin";
			break;
		case 't': 
			 training_image_fn = "cifar/cifar-10/cifar-10-batches-bin/test_batch.bin";
			break;
	}
